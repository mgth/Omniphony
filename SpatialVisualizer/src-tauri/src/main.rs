...
fn control_vbap_cart_z_neg_size(state: State<SharedState>, value: i32) {
    send_control(
        &state.osc_tx,
        OscControlMsg::SendInt {
            address: "/gsrd/control/vbap/cart/z_neg_size".to_string(),
            value: value.max(0),
        },
    );
}
...
fn control_room_ratio_lower(state: State<SharedState>, value: f32) {
    ...
    send_control(
        &state.osc_tx,
        OscControlMsg::SendFloat {
            address: "/gsrd/control/room_ratio_lower".to_string(),
            value: v,
        },
    );
}
...
fn control_reload_config(state: State<SharedState>) {
    send_control(
        &state.osc_tx,
        OscControlMsg::SendNoArgs {
            address: "/gsrd/control/reload_config".to_string(),
        },
    );
}
...
fn control_log_level(state: State<SharedState>, value: String) {
    ...
    send_control(
        &state.osc_tx,
        OscControlMsg::SendString {
            address: "/gsrd/control/log_level".to_string(),
            value: trimmed,
        },
    );
}
...
fn control_ramp_mode(state: State<SharedState>, value: String) {
    ...
    send_control(
        &state.osc_tx,
        OscControlMsg::SendString {
            address: "/gsrd/control/ramp_mode".to_string(),
            value: trimmed,
        },
    );
}
...
fn control_audio_output_device(state: State<SharedState>, output_device: String) {
    send_control(
        &state.osc_tx,
        OscControlMsg::SendString {
            address: "/gsrd/control/audio/output_device".to_string(),
