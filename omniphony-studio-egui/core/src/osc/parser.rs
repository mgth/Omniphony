...
pub enum OscEvent {
    ...
    StateLatencySmoothed {
        value: f64,
    },
    #[serde(rename = "state:latency:downstream")]
    StateLatencyDownstream {
        value: f64,
    },
...
#[cfg(test)]
mod tests {
    use super::{CoordinateFormat, OscEvent, parse_osc_message};
    use rosc::OscType;
